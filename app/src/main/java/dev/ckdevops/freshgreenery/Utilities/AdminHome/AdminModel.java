...
public class AdminModel {
    ...
    public AdminModel(String orderId, String userName, String rate, String date, String mobile, String time, String noItems, String addres, String city, String societyName, String flatNo, String ordermethod, String paymentMethod) {
        order = orderId;
        UserName = userName;
        Rate = rate;
        Date = date;
