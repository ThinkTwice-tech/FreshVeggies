...
public class FragmentHistoryUser extends Fragment {
    ...
    private TextView TVOrderId, TVName, TVMobile, TVDate, TVTime, TVNOItems, TVAmount, TVAddress, TVCity, TVSociety, TVFlat, TVPay;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TVPay = view.findViewById(R.id.textPayMethod);
                ...
                if (!(Search.equals("Nothing"))) {
                    ...
                    dfFetch.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            TVPay.setText(snapshot.child("PaymentMethod").getValue(String.class));
        ...
        databaseReference.child("Billing").child(uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot item : dataSnapshot.getChildren()) {
                    String orderId = item.child("Bill").child("OrderID").getValue(String.class);
                    if (orderId != null) {
                        arrayList.add(orderId);
                    }
                }
                if (arrayList.isEmpty()) {
                    arrayList.add("No Orders Available");
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(context, "Failed to load data: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
